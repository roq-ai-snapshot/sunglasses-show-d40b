...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`sunglasses show application`}</title>

        <meta
          name="description"
          content="Experience the Ultimate in Eyewear with Sunglasses Show Application: Your Virtual Gateway to the Latest Trends and Styles in Sunglasses."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1511499767150-a48a237f0083?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdW5nbGFzc2VzfGVufDB8fHx8MTY5MzMxNjI1MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`sunglasses show application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Ultimate in Eyewear with Sunglasses Show Application: Your Virtual Gateway to the Latest Trends and Styles in Sunglasses.`}
            </Text>
            <Box

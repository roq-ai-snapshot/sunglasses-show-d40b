...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'product.create': {
    roles: ['business-owner', 'store-manager', 'sales-associate', 'inventory-specialist'],
    key: 'product-added',
  ...
  'inventory.update': {
    ...
    tenantPath: ['organization', 'inventory'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'store-manager', 'sales-associate', 'inventory-specialist'];
